...
const aboutData = [
 ...
 },
 {
  ...
  info: [
   ...
   {
    title:
     "Computer Science Diploma - AV Technical Institute",
    stage: "2009",
   },
   {
    title:
...
const About = () => {
 ...
 return (
  <div className="h-full bg-primary/30 py-32 text-center xl:text-left z-[600] relative">
   <Circles />
   ...
   <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
    ...
    <div className="flex-1 flex flex-col justify-center">
     ...
     <motion.p 
      ...
      elit. Animi dolore unde dolorem aliquam harum quam
      repellat distinctio vero voluptatibus autem? Lorem
     ...
     <motion.div 
      ...
      <div className="flex flex-1 xl:gap-x-6">
       ...
       <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0 ">
        <div className="text-2xl xl:text-4xl font-semibold text-accent">
      ...
      <div className="flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 mb-4 ">
       {aboutData.map((item, i) => (
        <div
         ...
         className={`${
          index === i &&
          "text-accent after:w-[100%] after:bg-accent after: after:duration-300"
